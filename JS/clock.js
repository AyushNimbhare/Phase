let HrsFormat12 = false;
function changeFormat(){
    HrsFormat12 == false? HrsFormat12 = true : HrsFormat12 = false;
    clock();
}
function clock(){
    let now = new Date();
    ...
    if (HrsFormat12 == true) {
        if (TimeHours<10){
            hrs.innerHTML = '0'+ TimeHours;
        }
        else {
            hrs.innerHTML = TimeHours;
        }
    }
}
clock();
...
// function changeFormat() {
//     let time = new Date();
//     let timeHrs = document.getElementById("hrs");
//     let hrs12 = time.getHours() - 12;
//     if (time.getHours()>= 12) {
//         if (time.getHours()<10){
//             timeHrs.innerHTML = "0"+hrs12;
//         }
//         else {
//             timeHrs.innerHTML = hrs12;
//         }
//     }
// }
...
function startTimer(){
    ...
    if (Math.floor(time/60)<10){
        mins.innerText = "0" + Math.floor(time / 60);
    }
    else {
        mins.innerText =Math.floor(time / 60);
    }
    if ((time%60)<10){
...
function resetTimer(){
    ...
    else mins.innerText = Math.floor(time/60);
    secs.innerText = "00";
